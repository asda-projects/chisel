...
void main() {
  group('Chisel Database Integration Tests', () {
    ...
    setUp(() async {
      ...
      chisel.configureLogging(level: LogLevel.debug);
    ...
    test('Test getColumns - Fetch columns for a specific table', () async {
      ...
      final tableName =
          'auth_user'; // Replace with a table that exists in your test database
      ...
      expect(
          columns[0]['column_name'], isA<String>()); // Verify column metadata
    });

    test('Test introspectSchema - Introspect the entire database schema',
        () async {
    ...
    test('Test generateModels - Generate Dart models for the database schema',
        () async {
